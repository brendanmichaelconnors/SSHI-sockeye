...
bayes_R2 <- function(y, ypred) {
    ...
    ## ypred = matrix of predicted values: dima = [iter x N]
...
plot_post_pc <- function(stanfit, y,
    ...
    g <- ppc_dens_overlay(y = y, yrep = yrep[[1]][1:50, ]) +
        facet_wrap( ~ sock$Stock, as.table = FALSE) +
        ggtitle("Y rep: posterior predictive check")
    print(g)
...
## hb_param_df ---------------------------------------------
hb_param_df <- function(stanfit, par, region.var, var = NULL) {
...
stan_data <- function(data,
    ...
    sock.stan$Ocean.Region <- factor(sock.stan$Ocean.Region,
                                     levels = unique(sock.stan$Ocean.Region))
    ...
    start.end.grp.lst <- lapply(split(sock.stan, sock.stan$Ocean.Region),
    ...
    year.lst  <- lapply(split(sock.stan, sock.stan$Ocean.Region),
                        function(x) as.numeric(as.factor(x$BY)))
    if(length(unique(sock.stan$Ocean.Region)) == 1) {
        year <- year.lst[[1]]
    } else {
    ...
    lst <- list(y = sock.stan$lnRS,
                ...
                Ng_groups = length(unique(sock.stan$Ocean.Region)),
        ...
        for (j in unique(brood$BY)){
            ...
            if(type == "cumulative") {
                np.pink[as.character(j), as.character(i)] <-
                    ...
                    (brood$R0.2[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                    (brood$R0.3[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+3, pink.covar],
                                                       pink.data[pink.data$Year == j+4, pink.covar]))) +
                    (brood$R0.4[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+3, pink.covar],
                                                       pink.data[pink.data$Year == j+4, pink.covar],
                                                       pink.data[pink.data$Year == j+5, pink.covar])))+
                    (brood$R0.5[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+3, pink.covar],
                                                       pink.data[pink.data$Year == j+4, pink.covar],
                                                       pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar]))) +
                    brood$R1.1[brood$BY == j] * 0 +
                    (brood$R1.2[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar]) +
                    (brood$R1.3[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+4, pink.covar],
                                                       pink.data[pink.data$Year == j+5, pink.covar]))) +
                    (brood$R1.4[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+4, pink.covar],
                                                       pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar]))) +
                    (brood$R1.5[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+4, pink.covar],
                                                       pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar],
                                                       pink.data[pink.data$Year == j+7, pink.covar]))) +
                    brood$R2.1[brood$BY == j] * 0 +
                    (brood$R2.2[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                    (brood$R2.3[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar]))) +
                    (brood$R2.4[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar],
                                                       pink.data[pink.data$Year == j+7, pink.covar]))) +
                    (brood$R2.5[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+5, pink.covar],
                                                       pink.data[pink.data$Year == j+6, pink.covar],
                                                       pink.data[pink.data$Year == j+7, pink.covar],
                                                       pink.data[pink.data$Year == j+8, pink.covar]))) +
                    brood$R3.1[brood$BY == j] * 0 +
                    (brood$R3.2[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])+
                    (brood$R3.3[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+6, pink.covar],
                                                       pink.data[pink.data$Year == j+7, pink.covar]))) +
                    (brood$R3.4[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+6, pink.covar],
                                                       pink.data[pink.data$Year == j+7, pink.covar],
                                                       pink.data[pink.data$Year == j+8, pink.covar]))) +
                    brood$R4.1[brood$BY == j] * 0 +
                    (brood$R4.2[brood$BY == j] * pink.data[pink.data$Year == j+7, pink.covar])+
                    (brood$R4.3[brood$BY == j] * sum(c(pink.data[pink.data$Year == j+7, pink.covar],
                                                       pink.data[pink.data$Year == j+8, pink.covar])))
            }
            ...
            if(type == "second_year") {
                np.pink[as.character(j),as.character(i)] <-
                    (brood$R0.1[brood$BY == j] * 0) +
                    (brood$R0.2[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                    (brood$R0.3[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                    (brood$R0.4[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                    (brood$R0.5[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                    brood$R1.1[brood$BY == j] * 0 +
                    (brood$R1.2[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar]) +
                    (brood$R1.3[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar]) +
                    (brood$R1.4[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar]) +
                    (brood$R1.5[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar]) +
                    brood$R2.1[brood$BY == j] * 0 +
                    (brood$R2.2[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                    (brood$R2.3[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                    (brood$R2.4[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                    (brood$R2.5[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                    brood$R3.1[brood$BY == j] * 0 +
                    (brood$R3.2[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])+
                    (brood$R3.3[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])+
                    (brood$R3.4[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])+
                    brood$R4.1[brood$BY == j] * 0 +
                    (brood$R4.2[brood$BY == j] * pink.data[pink.data$Year == j+7, pink.covar])+
                    (brood$R4.3[brood$BY == j] * pink.data[pink.data$Year == j+7, pink.covar])
            }
            ...
            if(type == "geographic") {
                if (i < 153){
                    ...
                    np.pink[as.character(j),as.character(i)] <-
                        (brood$R0.1[brood$BY == j] * 0) +
                        (brood$R0.2[brood$BY == j] * pink.data[pink.data$Year == j+2, pink.covar]) +
                        (brood$R0.3[brood$BY == j] * pink.data[pink.data$Year == j+2, pink.covar]) +
                        (brood$R0.4[brood$BY == j] * pink.data[pink.data$Year == j+2, pink.covar]) +
                        (brood$R0.5[brood$BY == j] * pink.data[pink.data$Year == j+2, pink.covar]) +
                        brood$R1.1[brood$BY == j] * 0 +
                        (brood$R1.2[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                        (brood$R1.3[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                        (brood$R1.4[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                        (brood$R1.5[brood$BY == j] * pink.data[pink.data$Year == j+3, pink.covar]) +
                        brood$R2.1[brood$BY == j] * 0 +
                        (brood$R2.2[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar])+
                        (brood$R2.3[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar])+
                        (brood$R2.4[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar])+
                        (brood$R2.5[brood$BY == j] * pink.data[pink.data$Year == j+4, pink.covar])+
                        brood$R3.1[brood$BY == j] * 0 +
                        (brood$R3.2[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                        (brood$R3.3[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                        (brood$R3.4[brood$BY == j] * pink.data[pink.data$Year == j+5, pink.covar])+
                        brood$R4.1[brood$BY == j] * 0 +
                        (brood$R4.2[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])+
                        (brood$R4.3[brood$BY == j] * pink.data[pink.data$Year == j+6, pink.covar])
                }
            }
        } # end j loop
    } # end i loop
