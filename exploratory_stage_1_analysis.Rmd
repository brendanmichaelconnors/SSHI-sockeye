...
>>>>>>> 562faccc2e187e1e41d449b1c82e33fea025a92f
`r Sys.Date()`
...
brood_table <- subset(raw_brood_table, BY < 2015) 
brood_table <- subset(brood_table, BY > 1949) 
brood_table <- subset(brood_table, stock_name != "Cultus")  
brood_table$efs <-as.numeric(
                    levels(brood_table$total_effective_female_spawner)
